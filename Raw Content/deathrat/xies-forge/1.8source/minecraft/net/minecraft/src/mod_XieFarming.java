...
//		for (int i=0; i<5; i++) XieMod.tomatoTex[i]=ModLoader.addOverride("/terrain.png", "/Xie/img/terrain/tomato"+i+".png");
		for (int i=0; i<5; i++) XieMod.cocoaTex[i]=i + cocoaIndex;
		XieMod.cocoaPlant = (XieBlockBush) (new XieBlockBush(XieMod.Farming.BlockID.cocoaPlant, 
...
//			.setIconIndex(ModLoader.addOverride("/gui/items.png", "/Xie/img/items/food/corncobcooked.png")).setItemName("cornCobCooked");
		...
		XieMod.tomato = XieMod.addNewFood("Tomato",XieMod.Farming.ItemID.tomato,XieMod.Farming.FoodYield.tomato, 16, 2.4F);
		XieMod.tomatoPlant.setDrop(XieMod.tomato.shiftedIndex);
		
		XieMod.cocoaFruit = XieMod.newItem(XieMod.Farming.ItemID.cocoaFruit, 45, "Cocoa Fruit");
		XieMod.cocoaPlant.setDrop(XieMod.cocoaFruit.shiftedIndex);
...
//		XieMod.lemon = XieMod.newItem(XieMod.Farming.ItemID.lemon, ModLoader.addOverride("/gui/items.png", "/Xie/img/items/food/lemon.png"), "Lemon");
		...
		XieMod.avocado = XieMod.addNewFood("Avocado", XieMod.Farming.ItemID.avocado, XieMod.Farming.FoodYield.avocado, 21, 2.4F);
		XieMod.orangeJuice = XieMod.addNewContainedFood("Orange Juice", XieMod.Farming.ItemID.orangeJuice, XieMod.Farming.FoodYield.orangeJuice, Block.glass.blockID, 22, 6.0F);
		XieMod.lemonade = XieMod.addNewContainedFood("Lemonade", XieMod.Farming.ItemID.lemonade, XieMod.Farming.FoodYield.lemonade, Block.glass.blockID, 23, 6.0F);
		
		XieMod.guacamole = XieMod.addNewContainedFood("Guacamole", XieMod.Farming.ItemID.guacamole, XieMod.Farming.FoodYield.guacamole, Item.bowlEmpty.shiftedIndex, 24, 9.6F);
		...
		if (XieMod.Farming.Enable.lettuce)XieMod.seedsDropList.add(XieMod.lettuceSeeds); 
		if (XieMod.Farming.Enable.pumpkins) XieMod.seedsDropList.add(Item.pumpkinSeeds);
		if (XieMod.Farming.Enable.melons) XieMod.seedsDropList.add(Item.melonSeeds);
		if (XieMod.Farming.Enable.corn) XieMod.seedsDropList.add(XieMod.cornSeeds);
		if (XieMod.Farming.Enable.cotton) XieMod.seedsDropList.add(XieMod.cottonSeeds);
		if (XieMod.Farming.Enable.tomatoes) XieMod.seedsDropList.add(XieMod.tomatoSeeds);
		XieMod.seedsDropList.add(Item.seeds);
		XieMod.seedsDropList.add(XieMod.cocoaSeeds);
    ...
    public void AddRecipes() {
		...
		if (XieMod.Farming.Enable.pumpkins) {
			...
			if (XieMod.Farming.Settings.pumpkinSeedYield>0)
				XieMod.addRecipe(new ItemStack(Item.pumpkinSeeds, XieMod.Farming.Settings.pumpkinSeedYield), new Object[] {
		...
		XieMod.addRecipe(new ItemStack(XieMod.watermelonPiece, 4), new Object[] {
			"#", Character.valueOf('#'), Block.melon
		});
		
		// hybrid seeds
		XieMod.addShapelessRecipe(new ItemStack(XieMod.hybridSeeds), new Object[] {Item.redstone, Item.seeds});
		
		XieMod.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 3), new Object[] {XieMod.cocoaFruit});
		...
		if (XieMod.Farming.Enable.cotton) {
			XieMod.addShapelessRecipe(new ItemStack(XieMod.cottonSeeds), new Object[] {Item.pumpkinSeeds, XieMod.hybridSeeds});
		...
		if (XieMod.Farming.Enable.lettuce) {
			XieMod.addShapelessRecipe(new ItemStack(XieMod.lettuceSeeds), new Object[] {Item.melonSeeds, XieMod.hybridSeeds});
		}
		...
		if (XieMod.Farming.Enable.orangeTrees) {
			XieMod.addShapelessRecipe(new ItemStack(XieMod.treeManager.get(XieMod.ORANGE).sapling), new Object[] {Item.pumpkinSeeds, Block.sapling, XieMod.hybridSeeds});
		}
		...
		if (XieMod.Farming.Enable.avocadoTrees) {
			XieMod.addShapelessRecipe(new ItemStack(XieMod.treeManager.get(XieMod.AVOCADO).sapling), new Object[] {Item.melonSeeds, Block.sapling, XieMod.hybridSeeds});
		}
		...
		XieMod.addRecipe(new ItemStack(XieMod.jayCake), new Object[] {
			" X ", " Y ", " Z ", Character.valueOf('X'), new ItemStack(Item.dyePowder, 1, 3), Character.valueOf('Y'), XieMod.orange,
				Character.valueOf('Z'), Item.bread
		});
		
		XieMod.addShapelessRecipe(new ItemStack(XieMod.cocoaSeeds, 2), new Object[] { new ItemStack(Item.dyePowder, 1, 3) });
